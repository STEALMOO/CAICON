_base_ = [
    ...
    '../_base_/datasets/caicon.py', '../_base_/default_runtime.py'
]
...
model = dict(
    ...
    backbone=dict(
        ...
        frozen_stages=0,
        norm_cfg=dict(
            type='GN', num_groups=8, requires_grad=True),
        norm_eval=False,
        init_cfg=dict(
    ...
    train_cfg=dict(assigner=dict(neg_iou_thr=0.1)))
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=5e-3, weight_decay=0.0001),
